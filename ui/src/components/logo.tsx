...
export const BCMSLogo = defineComponent({
    setup() {
        return () => (
            <Transition name="logo" appear={true} duration={1000}>
                <Link
                    cyTag="go-home"
                    href="/d"
                    class={`w-20 fill-current text-dark dark:text-white min-h-[25px]`}
                >
                    <svg
