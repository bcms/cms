...
import type { PluginConfig } from '@bcms/selfhosted-backend/plugin/models/config';
import type { Plugin } from '@bcms/selfhosted-backend/plugin/models/main';
import type { PluginCreateData } from '@bcms/selfhosted-backend/plugin/models/main';
